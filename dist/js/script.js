// Importa las funciones necesarias de Firebase y otros paquetes
...
const firebaseConfig = {
  ...
  databaseURL: "https://newnextcan-default-rtdb.firebaseio.com",
...
window.addEventListener("load", () => {
    // Agrega un evento de click al botón de inicio de sesión
    ...
    signInBtn.addEventListener('click', () => {
        ...
        signInWithEmailAndPassword(auth, email, password)
            .then((userCredential) => {
                ...
                window.location.href = "https://bongo.cat/"; // Cambia la URL según tu necesidad
            })
            .catch((error) => {
